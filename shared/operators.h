...
DEF_OPER(40, PREFIX_ADD,      UNARY,  { PREFIX_OPER ("add"); })
DEF_OPER(41, PREFIX_SUB,      UNARY,  { PREFIX_OPER ("sub"); })
DEF_OPER(42, POSTFIX_ADD,     UNARY,  { POSTFIX_OPER("add"); })
DEF_OPER(43, POSTFIX_SUB,     UNARY,  { POSTFIX_OPER("sub"); })

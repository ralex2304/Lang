...
DEF_OPER(40, LOGIC_GREAT,      BINARY, MATH,     VAL, VAL,         { LOGIC(); })
DEF_OPER(41, LOGIC_LOWER,      BINARY, MATH,     VAL, VAL,         { LOGIC(); })
DEF_OPER(42, LOGIC_NOT_EQUAL,  BINARY, MATH,     VAL, VAL,         { LOGIC(); })
DEF_OPER(43, LOGIC_EQUAL,      BINARY, MATH,     VAL, VAL,         { LOGIC(); })
DEF_OPER(44, LOGIC_GREAT_EQ,   BINARY, MATH,     VAL, VAL,         { LOGIC(); })
DEF_OPER(45, LOGIC_LOWER_EQ,   BINARY, MATH,     VAL, VAL,         { LOGIC(); })

 ...
 * @return int
 */
int list_log_printf(LogFileData* log, const char* format, ...);
 ...
 */
bool list_log_open_file(LogFileData* log, const char* mode = "ab");
 ...
 * @return false failure
 */
bool list_log_close_file(LogFileData* log);

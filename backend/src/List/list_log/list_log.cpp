...
int list_log_printf(LogFileData* log_file, const char* format, ...) {
    assert(log_file);
    assert(format);
...
bool list_log_open_file(LogFileData* log_file, const char* mode) {
    assert(log_file);
...
bool list_log_create_timestamp_dir(LogFileData* log_file) {
    assert(log_file);
...
bool list_log_close_file(LogFileData* log_file) {
    assert(log_file);

...
struct ListNode {
    static constexpr ListElem_t POISON   = {.type = IRNodeType::DEFAULT};  //< poison value
    static const ssize_t EMPTY_INDEX = -1;                                 //< value for prev and next

    ssize_t prev = -1;      //< previus element index

    ListElem_t elem = POISON;   //< element value
 ...
 * @return int
 */
inline int list_insert_before(List* list, const size_t position, const ListElem_t elem, size_t* inserted_index) {
 ...
 * @return int
 */
inline int list_pushback(List* list, const ListElem_t elem, size_t* inserted_index) {
 ...
 * @return int
 */
inline int list_pushfront(List* list, const ListElem_t elem, size_t* inserted_index) {
